  ...
  stages {
    ...
    post {  
         ...
         success {   
            ...
            emailext attachLog: true, body: "<b>Example</b><br>Project: ${env.JOB_NAME}", from: 'kavikumarjk01@gmail.com',compressLog: true, mimeType: 'text/html', replyTo: '', subject: "Deploy Successfull Project ${env.JOB_NAME}", to: "kavikumarjk01@gmail.com";
         }  
         failure {  
